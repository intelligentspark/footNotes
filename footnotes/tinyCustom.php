...
setTimeout(function() {
  window.tinymce && tinymce.init({
    ...
    plugins: 'autosave charmap code fullscreen image importcss link lists paste searchreplace tabfocus table template visualblocks footnotes',
    ...
    extended_valid_elements: 'q[cite|class|title],article,section,hgroup,figure,figcaption,i[class|aria-hidden]',
    menubar: 'file edit insert view format table',
    toolbar: 'link unlink | image | bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | undo redo | code | footnotes'
  });
}, 0);
</script>
<?php endif; ?>
